...
BuildRequires:	%{?scl_prefix}perl(Test::CleanNamespaces)
%endif
...
%if ! 0%{?rhel}
%{?scl:scl enable %{scl} '}make test AUTHOR_TESTING=1 RELEASE_TESTING=1%{?scl:'}
%else
%{?scl:scl enable %{scl} '}make test RELEASE_TESTING=1%{?scl:'}
%endif
%else
%{?scl:scl enable %{scl} '}make test%{?scl:'}
%endif
...
%changelog
* Fri Jan 03 2020 Jitka Plesnikova <jplesnik@redhat.com> - 0.09-23
- SCL
